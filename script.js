    ...
    var addMarkers = function (dataset, map) {
        ...
        dataset.forEach(function(d) {
            ...
            if (d.MNTHYR = '12017') {
                console.log("pushing circle to jan17...");
                jan17.push(circle);
            } else if (d.MNTHYR = 22017) {
                console.log("pushing circle to feb17...");
                feb17.push(circle);
            } else if (d.MNTHYR = 32017) {
                console.log("pushing circle to mar17...");
                mar17.push(circle);
            } else if (d.MNTHYR = 42017) {
                console.log("pushing circle to apr17...");
                apr17.push(circle);
            } else if (d.MNTHYR = 52017) {
                console.log("pushing circle to may17...");
                may17.push(circle);
            } else if (d.MNTHYR = 62017) {
                console.log("pushing circle to jun17...");
                jun17.push(circle);
            } else if (d.MNTHYR = 72017) {
                console.log("pushing circle to jul17...");
                jul17.push(circle);
            } else if (d.MNTHYR = 82017) {
                console.log("pushing circle to aug17...");
                aug17.push(circle);
            } else if (d.MNTHYR = 92017) {
                console.log("pushing circle to sep17...");
                sep17.push(circle);
            } else if (d.MNTHYR = 102017) {
                console.log("pushing circle to oct17...");
                oct17.push(circle);
            } else   if (d.MNTHYR = 112017) {
                console.log("pushing circle to nov17...");
                nov17.push(circle);
            } else  if (d.MNTHYR = 122017) {
                console.log("pushing circle to dec17...");
                dec17.push(circle);
            } else if (d.MNTHYR = 12018) {
                console.log("pushing circle to jan18...");
                jan18.push(circle);
            } else if (d.MNTHYR = 22018) {
                console.log("pushing circle to feb18...");
                feb18.push(circle);
            }
        });
